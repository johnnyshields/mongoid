...
class Post
  ...
  belongs_to_one :author, foreign_key: :author_id, class_name: "User"
  belongs_to_one :post_genre, foreign_key: :genre_id, counter_cache: true
  belongs_to_many :tags, before_add: :before_add_tag, after_add: :after_add_tag, before_remove: :before_remove_tag, after_remove: :after_remove_tag
