  ...
  module Touchable
    ...
    module InstanceMethods
      ...
      def __gather_touch_updates(now, field = nil)
        ...
        touches = __extract_touches_from_atomic_sets(now, field) || {}

        # TODO: this needs to be `... if _parent && _parent_association.options[:touch]`
        # However, the `_parent_association` method doesn't exist!
      ...
      #
      # @api private
      def __extract_touches_from_atomic_sets(now, field = nil)
    ...
    def define_touchable!(association)
      ...
      association.inverse_class.tap do |klass|
        # TODO: for EMBEDDED docs, save/destroy should call .touch within the save/destroy action rather than as a callback?
